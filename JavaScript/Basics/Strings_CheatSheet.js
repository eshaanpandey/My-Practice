...
1+city;     
// 1Eshaan Pandey
// JS by default converts numbers to strings and add them

// String methods:
'hello'.toUpperCase(); // "HELLO";
'LOL'.toLowerCase(); // "lol"
'    omg  '.trim(); // "omg"
// .trim() eats up all the space on both sides, not in the middle
...
Math.ceil(4.7)      // 5
Math.floor(4.7)     // 4
// Math.abs(-10), Math.pow(2,5), Math.random() #generates random decimals between 0 and 1, non-inclusive